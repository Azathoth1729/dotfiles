...
, additionalFonts = [ "xft:Source Code Pro:pixelsize=11:antialias=true:hinting=true"
...
, commands = [
  ...
  , Run BatteryP ["BAT1"]
                 ...
                 , "-L", "20", "-H", "80"
                 , "-l", "#ff6c6b", "-h", "#da8548"
                 , "--", "-O", "Charging", "-o", "Battery: <timeleft> (<left>%)"
                 ] 360
...
, sepChar = "%"
, alignSep = "}{"
, template = "<action=`dm-run`><icon=haskell_20.xpm/></action>\
             ...
             \%trayerpad%"
--, template = "<action=`dm-run`><icon=haskell_20.xpm/></action><fc=#666666>|</fc> %UnsafeStdinReader%}{  <box type=Bottom width=2 mb=2 color=#51afef><fc=#51afef>%penguin% %kernel%</fc></box> <box type=Bottom width=2 mb=2 color=#ecbe7b><fc=#ecbe7b><action=`alacritty -e htop`>%cpu%</action></fc></box> <box type=Bottom width=2 mb=2 color=#ff6c6b><fc=#ff6c6b><action=`htop`>%memory%</action></fc></box> <box type=Bottom width=2 mb=2 color=#a9a1e1><fc=#a9a1e1></fc></box> <box type=Bottom width=2 mb=2 color=#98be65><fc=#98be65>%uparrow% %uptime%</fc></box> <box type=Bottom width=2 mb=2 color=#c678dd><fc=#c678dd>%bell% <action=`alacritty -e sudo pacman -Syu`>%pacupdate%</action></fc></box> <box type=Bottom width=2 mb=2 color=#da8548><fc=#da8548>%baticon% %battery%</fc></box> <box type=Bottom width=2 mb=2 color=#46d9ff><fc=#46d9ff><action=`emacsclient -c -a 'emacs' --eval '(doom/window-maximize-buffer(dt/year-calendar))'`>%date%</action></fc></box> %trayerpad%"
}
