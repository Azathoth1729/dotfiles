...
import           XMonad.Actions.CycleWS (Direction1D(..), moveTo, shiftTo
...
main = do
  ...
  xmproc2 <- spawnPipe
    ("xmobar -x 2 $HOME/.config/xmobar/" ++ colorScheme ++ "-xmobarrc")
  xmonad
    $ ewmh
      def -- simple stuff
